<template>
  <div class="authPage">
    <div class="authCard">
      ...
      <p class="subtitle">Pēc reģistrācijas uzreiz varēsi noformēt pieteikumu un redzēt savus pasūtījumus.</p>
      ...
      <form class="form" @submit.prevent="submit">
        ...
        <label class="field">
          <span class="label">Atkārtot paroli</span>
      ...
      <div class="footerLine">
        ...
        <RouterLink :to="loginLink">Ienākt</RouterLink>
      </div>
    </div>
  </div>
</template>
